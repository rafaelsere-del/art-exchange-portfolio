...
export function templateAceptacion({ artistName, artworkImageUrl, artworkTitle, completeUrl }) {
  const firstName = artistName ? artistName.split(" ")[0] : "artista";
  return `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Axia Art — Solicitud aceptada</title>
</head>
<body style="margin:0;padding:0;background-color:#f7f5f0;font-family:Georgia,'Times New Roman',serif;">
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:40px 40px 32px;">
              <p style="margin:0 0 8px;font-family:'DM Sans',Helvetica,Arial,sans-serif;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:#5a7a5e;">
                Solicitud aceptada
              </p>
              <p style="margin:0 0 24px;font-family:'Palatino Linotype',Palatino,Georgia,serif;font-size:26px;font-weight:400;color:#14120e;line-height:1.3;">
                ${firstName}, tu obra<br/>
                <em style="color:#b8953a;">fue aceptada.</em>
              </p>
              <p style="margin:0 0 24px;font-family:Georgia,serif;font-size:15px;color:#3a3630;line-height:1.85;">
                Revisamos tu solicitud y nos encantó tu trabajo. Ahora podés crear tu cuenta y empezar a intercambiar tu obra con otros artistas.
              </p>
              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 0 28px;width:100%;">
                <tr>
                  <td style="background-color:#f7f5f0;border-radius:6px;padding:16px;text-align:center;">
                    <p style="margin:0 0 12px;font-family:'DM Sans',Helvetica,Arial,sans-serif;font-size:9px;letter-spacing:0.18em;text-transform:uppercase;color:#9ca891;">Tu obra</p>
                    <img src="${artworkImageUrl}" alt="${artworkTitle || "Tu obra"}" style="max-width:100%;max-height:300px;border-radius:4px;display:block;margin:0 auto;" />
                    ${artworkTitle ? `<p style="margin:10px 0 0;font-family:'Palatino Linotype',Palatino,Georgia,serif;font-size:13px;font-style:italic;color:#6a7260;">${artworkTitle}</p>` : ""}
                  </td>
                </tr>
              </table>` : ""}

              <p style="margin:0 0 28px;font-family:Georgia,serif;font-size:14px;color:#6a7260;line-height:1.85;">
                Tu obra ya va a estar cargada en tu galería cuando completes el registro.
              </p>

              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#b8953a;border-radius:4px;">
                    <a href="${completeUrl}" style="display:inline-block;padding:14px 32px;font-family:'DM Sans',Helvetica,Arial,sans-serif;font-size:11px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#ffffff;text-decoration:none;">
                      Crear mi cuenta &#8594;
                    </a>
                  </td>
                </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    ...
                    <p style="margin:6px 0 0;font-family:'DM Sans',Helvetica,Arial,sans-serif;font-size:10px;color:#b8b4ac;line-height:1.6;">
                      Recibiste este mensaje porque tu solicitud fue aceptada.<br/>
                      Si tenés problemas con el enlace, respondé este email.
                    </p>
                  </td>
                  <td align="right" valign="top">
                    <table cellpadding="0" cellspacing="0">
